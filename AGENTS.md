...
**Description:** A modern, sleek, interactive web todo manager with local storage persistence, filtering, and animations.
**Tech Stack:** HTML5, Vanilla CSS3, JavaScript (ES6+), Vitest (for unit testing)
