---
agent-notes: { ctx: "GCP service landscape for cloud specialists", deps: [.agents/agents/cloud-architect.md, .agents/agents/cloud-costguard.md, .agents/agents/cloud-netdiag.md], state: active, last: "cloud-architect@2026-02-12" }
---
