...
> Created from [vteam-hybrid](https://github.com/noodle/vteam-hybrid) — a virtual development team for [Antigravity](https://docs.anthropic.com/en/docs/antigravity-code).
