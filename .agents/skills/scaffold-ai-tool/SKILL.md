...
description: Scaffold an AI / data-centric tool
---

<!-- agent-notes: { ctx: "AI/data-centric tool scaffold workflow", deps: [AGENTS.md], state: active, last: "sato@2026-02-12" } -->
...
### In all cases, also:
- Update `AGENTS.md` with the chosen tech stack and conventions
