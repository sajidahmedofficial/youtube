...
<!-- agent-notes: { ctx: "session handoff for wave-based sprint execution", deps: [AGENTS.md, docs/sprints/, docs/code-map.md], state: active, last: "coordinator@2026-02-15" } -->
...
6. **Write the handoff file.** Create or update `.agents/handoff.md` with this structure:
