...
<!-- agent-notes: { ctx: "CLI project scaffold workflow", deps: [AGENTS.md], state: active, last: "sato@2026-02-12" } -->
...
### In all cases, also:
- Update `AGENTS.md` with the chosen tech stack, how to run tests, how to build, and any conventions
