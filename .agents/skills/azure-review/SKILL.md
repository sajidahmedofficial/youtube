---
name: azure-review
description: Run a multi-lens review of Azure deployment readiness
---

<!-- agent-notes: { ctx: "multi-lens Azure deployment readiness review", deps: [docs/research/azure-landscape.md, .agents/agents/cloud-architect.md, .agents/agents/cloud-costguard.md, .agents/agents/cloud-netdiag.md], state: active, last: "cloud-architect@2026-02-12" } -->
...
- Check `AGENTS.md` and `docs/adrs/` for documented Azure decisions.
