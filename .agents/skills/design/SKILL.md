---
name: design
description: Run a design exploration with sacrificial concepts for
---

<!-- agent-notes: { ctx: "sacrificial concept design exploration", deps: [docs/methodology/personas.md, .agents/agents/dani.md], state: active, last: "dani@2026-02-12" } -->
