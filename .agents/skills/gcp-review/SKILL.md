---
name: gcp-review
description: Run a multi-lens review of GCP deployment readiness
---

<!-- agent-notes: { ctx: "multi-lens GCP deployment readiness review", deps: [docs/research/gcp-landscape.md, .agents/agents/cloud-architect.md, .agents/agents/cloud-costguard.md, .agents/agents/cloud-netdiag.md], state: active, last: "cloud-architect@2026-02-12" } -->
...
- Check `AGENTS.md` and `docs/adrs/` for documented GCP decisions.
