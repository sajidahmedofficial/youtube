---
name: restack
description: Reconsider and update the project's tech stack
---

<!-- agent-notes: { ctx: "tech stack reevaluation workflow", deps: [AGENTS.md, docs/adrs/], state: active, last: "archie@2026-02-12" } -->
...
- Read `AGENTS.md` to understand the current tech stack and conventions.
...
- Update `AGENTS.md` with the new stack details
