---
name: aws-review
description: Run a multi-lens review of AWS deployment readiness
---

<!-- agent-notes: { ctx: "multi-lens AWS deployment readiness review", deps: [docs/research/aws-landscape.md, .agents/agents/cloud-architect.md, .agents/agents/cloud-costguard.md, .agents/agents/cloud-netdiag.md], state: active, last: "cloud-architect@2026-02-12" } -->
...
- Check `AGENTS.md` and `docs/adrs/` for documented AWS decisions.
