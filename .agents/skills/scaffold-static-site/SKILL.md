...
<!-- agent-notes: { ctx: "static site scaffold for GitHub Pages", deps: [AGENTS.md], state: active, last: "sato@2026-02-12" } -->
...
### In all cases, also:
- Update `AGENTS.md` with the chosen tech stack, how to dev/build/deploy, and conventions
